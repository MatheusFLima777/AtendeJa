...
public class DBService {
	...
	public DBService(ChamadoRepository chamadoRepository,PessoaRepository pessoaRepository, BCryptPasswordEncoder encoder){
	...
	public void instanciaDB() {
		...
		Tecnico tec1 = new Tecnico(null, "Matheus Lima", "457.696.698-70", "matheus.lima@dellavolpe.com", encoder.encode("25022003Ma"));
		...
		Chamado c1 = new Chamado(null, Prioridade.MEDIA, Status.PENDENTE, "Chamado 1", "Teste chamado 1", tec1, cli1);
		Chamado c2 = new Chamado(null, Prioridade.ALTA, Status.ABERTO, "Chamado 2", "Teste chamado 2", tec1, cli2);
		Chamado c3 = new Chamado(null, Prioridade.BAIXA, Status.ENCERRADO, "Chamado 3", "Teste chamado 3", tec2, cli3);
		Chamado c4 = new Chamado(null, Prioridade.ALTA, Status.ABERTO, "Chamado 4", "Teste chamado 4", tec3, cli3);
		Chamado c5 = new Chamado(null, Prioridade.MEDIA, Status.PENDENTE, "Chamado 5", "Teste chamado 5", tec2, cli1);
